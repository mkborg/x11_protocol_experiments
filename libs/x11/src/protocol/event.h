...
struct Base
{
  uint8_t id:7;		// 0 'error', 1 'success reply', 2..34 events
  uint8_t sendEvent:1;	// The most significant bit is set if the event was generated by SendEvent request.
  uint8_t plaaceholder[31];
};
